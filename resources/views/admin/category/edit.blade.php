            ...
            <form action="{{ route('categories.update', $category) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <div class="image-preview mt-2" id="imagePreview">
                        <i class="fas fa-image text-secondary {{ $category->cover_image ? 'd-none' : '' }}" id="imagePreviewIcon"> No image selected</i>
                        <img id="imagePreviewImg" class="img-fluid {{ $category->cover_image ? '' : 'd-none' }}" width="120" height="120" alt="Category Image Preview" src="{{ $category->cover_image ? asset('storage/' . $category->cover_image) : 'https://via.placeholder.com/120' }}">
                    </div>
                </div>
