                    ...
                    <div class="col-md-7">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description"
                                rows="4">{{ $audio->description }}</textarea>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" id="cover_image" name="cover_image" accept="image/*"
                                onchange="changeImagePreview(event)">
                            <small class="text-muted">Upload a cover image for the audio (recommended size:
                                400x400px)</small>

                            <div class="image-preview mt-2" id="imagePreview">
                                <i class="fas fa-image text-secondary {{ $audio->cover_image ? 'd-none' : '' }}"
                                    id="imagePreviewIcon"> No image selected</i>
                                <img id="imagePreviewImg" class="img-fluid {{ $audio->cover_image ? '' : 'd-none' }}"
                                    width="120" height="120" alt="Audio Image Preview"
                                    src="{{ $audio->cover_image ? asset('storage/' . $audio->cover_image) : 'https://via.placeholder.com/120' }}">
                            </div>
                        </div>
                    </div>
                </div>
